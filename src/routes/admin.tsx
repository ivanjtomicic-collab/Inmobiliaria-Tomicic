  ...
  return (
    <main className="mx-auto max-w-7xl px-6 py-12">
      ...
      <form onSubmit={submit} className="grid gap-5 rounded-3xl border bg-card p-6 text-card-foreground shadow-sm md:grid-cols-2">
        ...
        <Field label="Tipo"><select value={form.type} onChange={(e) => update("type", e.target.value as PropertyInput["type"])}><option value="casa">Casa</option><option value="terreno">Lote</option><option value="departamento">Departamento</option><option value="galpon">Galpón</option></select></Field>
